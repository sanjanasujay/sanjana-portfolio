    ...
    <div className="projects-container" id="projects">
        ...
        <div className="projects-grid">
            ...
            <div className="project">
                ...
                <p>Tools: Python, LangChain, OpenAI API, ChromaDB, FAISS, Hugging Face, Prompt Engineering</p>
             ...
             <div className="project">
                ...
                <p>Tools: Python, FastAPI, PostgreSQL, SQLAlchemy, OpenAI API, Docker</p>
...
urgency, and auto-escalates low-confidence cases, improving routing accuracy and system reliability.</p>
             ...
             <div className="project">
                ...
                <p>Tools: Next.js, React Flow, Go, GraphQL, Apollo Client</p>
...
and bottlenecks using a Go-based simulation engine.</p>
            ...
            <div className="project"  >
               <img src={mock03} className="zoom" alt="thumbnail" width={"80%"}   />
                ...
                <p>Tools: Python, Natural Language Processing, Transformer Architecture, Neural Machine Translation</p>
            ...
            <div className="project">
              ...
              <p>Tools: Python, Linear Regression, Decision Tree, Random Forest, XGBoost</p>
                <p>Built and compared multiple models to forecast daily product-level revenue 30 days ahead. Engineered time-series and calendar features to capture seasonality and festive effects, and performed scenario-based forecasting to quantify holiday-driven revenue uplift for inventory and promotion planning.</p>
            </div>
            <div className="project">
                <img src={cafeDB} className="zoom" alt="thumbnail" width={"80%"}/>
                <h2>Café Database Management System</h2>
                <p>Tools: using HTML, CSS, JavaScript, PHP, MySQL</p>
                <p>Developed a full-stack food ordering website with dynamic menu-based ordering, enabling real-time order tracking. Through optimized MySQL queries and schema design, ensured smooth transaction handling.</p>
            </div>
